...
MONGO_DB_URI = getenv("MONGO_DB_URI", "mongodb+srv://VeGaMusIc:VeGaOne@cluster0.nf0ml.mongodb.net/?retryWrites=true&w=majority")
...
LOG_GROUP_ID = int(getenv("OWNER_ID", "7728230165"))

OWNER_ID = int(getenv("OWNER_ID", 7728230165))

PRIVACY_LINK = getenv(
    "PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-VeGaXMusic-08-30"
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/kafra_wi_1"
)

SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/Ka_fraw_i1"
)

VEGABOTS_CHANNEL = getenv("VEGABOTS_CHANNEL", "https://t.me/xvwwvl")

QURAN_CHANNELL = getenv("VEGABOTS_CHANNEL", "https://t.me/xvwwvl") 
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/xvwwvl")
...
START_video_URL = getenv(
    "START_video_URL", "https://t.me/kafra_wi_1/124"
)
