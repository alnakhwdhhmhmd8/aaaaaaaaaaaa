...
from VeGaXMusic.utils import seconds_to_min, time_to_seconds
from VeGaXMusic.utils.channelplay import get_channeplayCB
from VeGaXMusic.utils.database.memorydatabase import is_video_allowed
from VeGaXMusic.utils.database.assistantdatabase import get_client
from VeGaXMusic.utils.decorators.must_join import must_join_ch
from VeGaXMusic.utils.decorators.language import languageCB
from VeGaXMusic.utils.decorators.play import PlayWrapper
from VeGaXMusic.core.userbot import assistants
from VeGaXMusic.utils.formatters import formats
from VeGaXMusic.utils.inline.play import (
    livestream_markup,
    playlist_markup,
    slider_markup,
    track_markup,
)
from VeGaXMusic.utils.inline.playlist import botplaylist_markup
from VeGaXMusic.utils.logger import play_logs
from VeGaXMusic.utils.stream.stream import stream

@app.on_message(filters.command(["تشغيل","شغل","فيديو","فديو"], "") & ~BANNED_USERS, group=11135)
...
@app.on_callback_query(filters.regex("VeGayPlaylists") & ~BANNED_USERS)
@languageCB
