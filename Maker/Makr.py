...
db = mongo_client["KIM"]["sheikh7skkx72jdjd8329"]
mkchats = db.chatss
blocked = []
...
async def SourceVeGaX(client: Client, message):
    await message.reply_video(
        video="https://t.me/wwvvwt/124",
        caption="<blockquote><b>╭❖ᚐᴡᴇʟᴄᴏᴍᴇ ᴛᴏ\n╰⬣ᚐ[ꜱʜᴇɪᴋʜ ꜱᴏᴜꝛᴄᴇ](https://t.me/wwvvwt)\n╭⊚ᚐ[ɢꝛᴏᴜᴘ](https://t.me/VeGaSuport)\n╰❖ᚐ[ᴄᴧʟɴɴʟᴇ](https://t.me/wwvvwt)</b></blockquote>",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("ꜱʜᴇɪᴋʜ", url="https://t.me/wwvvwt"),
                ],
                [
                    InlineKeyboardButton("Me ", url="https://t.me/wwvvwt"),
                ],
            ]
        ),
    )
...
╰❖  ᴏᴡɴᴇꝛ ᴏꜰ ꜱʜᴇɪᴋʜ:[ᴢᴇʀᴏ⸥](https://t.me/wwvvwt)
</b></blockquote>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "ᴍᴀᴅᴏ", url=f"https://t.me/wwvvwt"),         
                ],[
                    InlineKeyboardButton(
                        "ꜱʜᴇɪᴋʜ", url=f"https://t.me/wwvvwt"),
               ],
          ]
        ),
    )
...
async def wwvvwt(client: Client, message):   
...
async def promote_dev(client, message):
    if message.from_user.id not in [7728230165, 7728230165, 7728230165]:
...
async def stop_specific_bot(c, message):
 if message.from_user.id in [7728230165, 7728230165, 7728230165]:    
